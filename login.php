...
<body class="landing-page sidebar-collapse">
  ...
  <div class="page-header header-filter" data-parallax="true" style="background-image: url('login/img/home.jpg')">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          ...
          <br>          
          <a href="daftar.php" class="btn btn-info btn-raised btn-lg">
